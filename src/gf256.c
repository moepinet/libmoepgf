...
static const uint8_t alogt[2*GF256_SIZE] = GF256_ALOG_TABLE;
static const uint8_t logt[GF256_SIZE] = GF256_LOG_TABLE;
static const uint8_t tab[GF256_SIZE][GF256_SIZE] = GF256_MUL_TABLE;
